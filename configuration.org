...
(defun mpereira/which-function-mode ()
  "TODO: docstring."
  (interactive)
  (which-function-mode t)
  (setq mode-line-misc-info (assq-delete-all 'which-function-mode mode-line-misc-info)))

(add-hook 'prog-mode-hook #'mpereira/which-function-mode)
#+END_SRC
...
(use-package evil
  ...
  ;; FIXME: Supposedly make it possible to navigate through search history with
  ;; up/down keys. Doesn't seem to be working. Update: trying in init,
  ;; commenting fix below.
  (setq evil-search-module 'evil-search)
  :config
  (evil-mode t)

  ;; Fix for the above. Commenting out for now to try evil-search-module in init.
  ;; (general-define-key
  ;;  :keymaps '(isearch-mode-map evil-ex-search-keymap)
  ...
  ;; Maybe it's related to the difference between `evil-ex-search-forward' and
  ;; `evil-search-forward'.
...
(use-package evil-collection
  ...
  :after evil
  :config
  (evil-collection-init '(package-menu disk-usage))
