...
otherwise."
  (interactive)
  (let* ((org-agenda-buffer-name "*Main Org Agenda*")
...
otherwise."
  (interactive)
  (let* ((org-agenda-buffer-name "*Review Org Agenda*")
         (org-agenda-buffer (get-buffer org-agenda-buffer-name)))
...
(defun mpereira/close-org-agenda ()
  "Close the last opened org agenda and restore the previous window
