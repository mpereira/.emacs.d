            ...
            (agenda ""
                    ((org-agenda-overriding-header
                     ...
                     (org-agenda-skip-function
                      `(org-agenda-skip-entry-if 'todo ,agenda-ignore-todos))))
            (agenda ""
                    ((org-agenda-overriding-header "\nNext 7 Days")
...
(use-package magit-todos
  ...
  ;; Refresh TODOs daily. Maybe set this on a per-project basis?
  ;; FIXME: This doesn't seem to work as expected, the magit-todos section is
  ;; still updated when calling magit-status.
